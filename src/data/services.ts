import { Service, ServiceJourneyStep } from "@/types";
...
export const serviceJourney: ServiceJourneyStep[] = [
  {
    id: "orientation",
  ...
  },
  {
    ...
    detail:
      "Le suivi continue jusqu'au départ with un point clair sur vos tâches restantes, vos échéances et les documents à garder prêts.",
